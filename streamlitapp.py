    ...
    with col1:
        ...
        if input_method == "📁 File Upload":
            ...
            sample_option = st.selectbox(
                ...
                ["Select...", "Sample Defected Tile", "Sample Non-Defected Tile"]
            )
            if sample_option != "Select...":
                # In a real app, you'd load actual sample images
                st.info("Sample images would be loaded here in production")
